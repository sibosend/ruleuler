    ...
    render(){
        ...
        const body=(
            <div>
                ...
                <div className="form-group">
                    <label>存储方式</label>
                    <select className="form-control" name="storageType">
        ...
        buttons.push(
            {
                ...
                click:function () {
                    ...
                    var storageType=document.getElementsByName('storageType')[0].value;
                    setTimeout(function () {
                        dispatch(action.createNewProject(newProjectName,storageType,this.state.nodeData));
                    }.bind(this),200);
                }.bind(this)
            }
        );
