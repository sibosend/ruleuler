...
export default class Splitter extends Component{
    _sanitizeSplitterPositionValue(position) {
        ...
        return newPosition;
        // const minWidth = Number.isFinite(this.props.minWidth) ? this.props.minWidth : 0;
        // if (!Number.isFinite(position)) {
        //     return minWidth;
        // }
        // const maxAllowed = Math.max(window.innerWidth - minWidth, minWidth);
        // return Math.min(Math.max(position, minWidth), maxAllowed);
    }
    componentDidMount(){
